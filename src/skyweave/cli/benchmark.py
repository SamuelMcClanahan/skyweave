...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--frames", type=int, default=300, help="Measured frame count.")
    parser.add_argument("--warmup", type=int, default=30, help="Warmup frame count excluded from timings.")
...
def run_benchmark(config_path: str | Path, frames: int = 300, warmup: int = 30) -> BenchmarkResult:
    if frames <= 0:
